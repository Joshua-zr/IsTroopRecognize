...
import com.istroop.istrooprecognize.utils.IUploadListener;
import com.istroop.istrooprecognize.utils.ImageAsyncTask;
import com.istroop.istrooprecognize.utils.ImageCompressUtil;
...
public class HistoryActivity extends BaseActivity implements OnClickListener,
    ...
    protected static final int    HIS_INFO_SUCCESS   = 2;
    protected static final int    HIS_INFO_FAIL      = 3;
    ...
    private        RelativeLayout                     icard_his_title;
    private        LinearLayout                       icard_home_top;
    private static ImageView                          icard_home_top_head;
    private static TextView                           icard_home_top_title;
    private static TextView                           icard_home_top_desc;
    private static ImageView                          icard_home_top_iv;
    ...
    // private ProgressBar his_progresss;
    ...
    protected void onResume() {
        ...
        if ( IstroopConstants.isLogin ) {
            ...
            icard_home_top.setVisibility( View.GONE );
            icard_his_title.setVisibility( View.VISIBLE );
    ...
    public void onCreate( Bundle savedInstanceState ) {
        ...
        // Log.i(TAG,"历史记录引用的"+mActivity);
        title = ( TextView ) findViewById( R.id.titleText );
        icard_his_title = ( RelativeLayout ) findViewById( R.id.icard_his_title );
        icard_home_top = ( LinearLayout ) findViewById( R.id.icard_home_top );
        TextView icard_home_map = ( TextView ) findViewById( R.id.icard_home_map );
        icard_home_top_head = ( ImageView ) findViewById( R.id.icard_home_top_head );
        icard_home_top_title = ( TextView ) findViewById( R.id.icard_home_top_title );
        icard_home_top_desc = ( TextView ) findViewById( R.id.icard_home_top_desc );
        icard_home_top_iv = ( ImageView ) findViewById( R.id.icard_home_top_iv );
        ...
        icard_home_top.setOnClickListener( this );
        icard_home_map.setOnClickListener( this );
        icard_home_top_head.setOnClickListener( this );
        icard_home_top_title.setOnClickListener( this );
        icard_home_top_desc.setOnClickListener( this );
    ...
    private void initHis() {
        new Thread() {
            public void run() {
                String histories = HttpTools.userInfo(
                        IstroopConstants.URL_PATH + "/ICard/MyHistory/",
    ...
    public void onClick( View v ) {
        switch ( v.getId() ) {
            case R.id.icard_home_top:
                Intent intent = new Intent( HistoryActivity.this, ActionSheet.class );
                Bundle bundle = new Bundle();
                bundle.putString( "image_type", "首页背景图片" );
                intent.putExtras( bundle );
                getParent().startActivityForResult( intent, ICARD_HOME_TOP );
                break;
            case R.id.icard_home_map:
                Intent intent2 = new Intent( HistoryActivity.this,
                                             ICardMapActivity.class );
                startActivity( intent2 );
                break;
            case R.id.icard_home_top_head:
                // MainActivity.tabHost.setCurrentTab(3); 进入
                BroadcastHelper.sendBroadCast( HistoryActivity.this,
                                               IstroopConstants.WHERE_PAGE_ACTION,
                                               IstroopConstants.WHERE_PAGE_KEY, 5 );
                break;
            case R.id.his_menu:
            ...
            case ICARD_HOME_TOP:
                if ( data != null ) {
                    ...
                    if ( bundle != null ) {
                        ...
                        byte[] bitmap2Bytes = bundle.getByteArray( "dataImage" );
                        Bitmap picFromBytes = BitmapUtil.getPicFromBytes(
                                bitmap2Bytes, new BitmapFactory.Options() );
                        icard_home_top.setBackgroundDrawable( new BitmapDrawable(
                                picFromBytes ) );
                    }
                }
                break;
            ...
            case ICARD_HOME_TOP:
                ...
                if ( data != null ) {
                    ...
                    if ( bundle != null ) {
                        ...
                        Bitmap compressBySize = ImageCompressUtil.compressBySize(
                                Environment.getExternalStorageDirectory().getPath() + "/istroop/ichaotu_upload.jpg", 400, 800 );
                        icard_home_top_iv.setImageBitmap( compressBySize );
                    }
                }
    ...
    class HistoryHandler extends Handler {
        ...
        public void handleMessage( Message msg ) {
            ...
            switch ( msg.what ) {
                case HIS_INFO_SUCCESS:
                    String[] userInfos = ( String[] ) msg.obj;
                    if ( userInfos != null ) {
                        loadImage( icard_home_top_head, userInfos[0] );
                        if ( !TextUtils.isEmpty( userInfos[1] )
                                && !"null".equals( userInfos[1] ) ) {
                            icard_home_top_title.setText( userInfos[1] );
                        }
                        if ( !TextUtils.isEmpty( userInfos[2] )
                                && !"null".equals( userInfos[2] ) ) {
                            icard_home_top_desc.setText( userInfos[2] );
                        }
                        Log.i( TAG, "http://tstatics.tujoin.com/print.php?url="
                                + userInfos[4] );
                        // imageDownloader.download("http://tstatics.tujoin.com/print.php?url="+userInfos[4],
                        // icard_home_top_iv);
                        loadImage2( icard_home_top_iv,
                                    "http://tstatics.tujoin.com/print.php?url="
                                            + userInfos[4] );
                        // 设置个性签名的颜色和背景图片 TODO
                    }
                    Log.i( TAG, "对历史记录进行初始化" );
                    initHis();
                    break;
                case HIS_INFO_FAIL:
                    //TODO
