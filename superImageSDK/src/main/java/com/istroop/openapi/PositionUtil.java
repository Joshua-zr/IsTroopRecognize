...
public class PositionUtil {
    ...
    public static Coordinate bd09_To_Gps84(double bd_lat, double bd_lon) {
        ...
        Coordinate map84 = PositionUtil.gcj_To_Gps84(gcj02.latitude,
                                                     gcj02.longitude);
        return map84;
     ...
     * @return
     */
    public static Coordinate gps84_To_bd09(double bd_lat, double bd_lon) {
        Coordinate gcj02 = PositionUtil.gps84_To_Gcj02(bd_lat, bd_lon);
        Coordinate bd09 = null;
        if (gcj02 != null) {
            bd09 = PositionUtil.gcj02_To_Bd09(gcj02.latitude, gcj02.longitude);
        }
        return bd09;
    }
